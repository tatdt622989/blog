...
### 任务目标与交付标准
- **角色设定**：银发、深红瞳孔、黑色皮质斗篷、手握长剑。
- **动作要求**：双手执剑迎战的动态姿态，透视为微仰角，五指抓握剑柄必须严格符合人体工学。
...
![OpenPose 空间骨骼姿态约束（流程示意图）](pipeline_stage1_openpose_v2.jpg)
...
![初版构图粗胚采样（流程示意图，锁定随机种子）](pipeline_stage2_draft_v2.jpg)
...
![ADetailer 局部修手修脸器官前后对比（效果示意图）](pipeline_stage3_adetailer_v2.jpg)
...
> 注：为直观解说确定性管线中各节点的演进原理，上方步骤 1 至步骤 3 包含流程原理示意与局部修复对比效果图；步骤 4 与步骤 5 则为基于 RTX 4090 算力与 RMBG 2.0 模型实测输出之高分辨率成果与透明去背交付品。
